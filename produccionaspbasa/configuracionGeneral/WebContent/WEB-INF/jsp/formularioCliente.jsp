											...
											<tr>
												...
												<td >
													<table>
														<tr>
															<td class="texto_ti"><spring:message
																	code="formularioCliente.datosCliente.controlaReferencia"
																	htmlEscape="true" /></td>
															<td class="texto_ti"><input type="checkBox"
																id="controlaReferencias" name="controlaReferencias" style="width: 10px;"
																value="1"
																<c:if test="${clienteFormulario.controlaReferencias == 1}">
																checked="CHECKED"
															</c:if>
											...
											<tr>
												...
												<td>
													<table>
														<tr>
															<td class="texto_ti"><spring:message
																	code="formularioCliente.datosCliente.reqTipoTrabajo"
																	htmlEscape="true" /></td>
															<td class="texto_ti"><input type="checkBox"
																id="reqTipoTrabajo" name="reqTipoTrabajo" style="width: 10px;"
																value="true"
																<c:if test="${clienteFormulario.reqTipoTrabajo == 'true'}">
														checked="CHECKED"
													</c:if>
																<c:if test="${accion == 'CONSULTA'}">
														disabled="disabled"
												...
												<td class="texto_ti">
														<select id="empresaAdministra" name="empresaAdministra" size="1" class="requerido"
															...
															<option value="" 
																<c:if test="${clienteFormulario.empresaAdministra == null || clienteFormulario.empresaAdministra == ''}">
																	selected = "selected"
																</c:if>
															>
																BASA
															...
															<option value="BASA" 
																<c:if test="${clienteFormulario.empresaAdministra == 'BASA'}">
																	selected = "selected"
																</c:if>
															>
																BASA
															...
															<option value="CUSTODIA"
																<c:if test="${clienteFormulario.empresaAdministra == 'CUSTODIA'}">
																	selected = "selected"
																</c:if>
															>
																CUSTODIA
										...
										<fieldset>
											...
											<table>
												<tr>
													...
													<td class="texto_ti"><spring:message
															code="formularioCliente.datosCliente.cantidadDeCajas"
															htmlEscape="true" />
													</td>
													<td class="texto_ti"><spring:message
															code="formularioCliente.datosCliente.modelo"
															htmlEscape="true" />
													</td>
												</tr>
												<tr>
													...
													<td class="texto_ti"><input type="text" id="cantidadDeCajas" class="requerido"
														name="cantidadDeCajas" style="width: 200px;" maxlength="60"
														value="<c:out value="${clienteFormulario.cantidadDeCajas}" default="" />"
														<c:if test="${accion != 'NUEVO'}">
															readonly="readonly"
														</c:if> />
													</td>
													<td class="texto_ti"><input type="text" id="modelo" class="requerido"
														name="modelo" style="width: 200px;" maxlength="60"
														value="<c:out value="${clienteFormulario.modelo}" default="" />"
														<c:if test="${accion != 'NUEVO'}">
																	readonly="readonly"
																</c:if> />
													</td>
